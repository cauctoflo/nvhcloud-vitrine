...
<html lang="fr">
	<head>
		...
		<title>NVHCloud SAS - VPS Intel</title>
	...
	<body class=" w-screen overflow-x-hidden ">
					...
					<div class="row justify-content-center">
						<div class="items-center sm:flex sm:flex-col sm:align-center ">
							<div class="section-heading text-center mb-5">
								...
								<h1 class="inline-flex items-center content-center text-5xl font-extrabold text-center text-gray-900 sm:text-center">&nbsp;VPS Intel</h1>
								<div class="hidden sm:block h-1 w-64 rounded-3xl  mb-2 mt-2 mx-auto border-b-4 border-[#00aaff]"></div>
								<p class="mt-2 w-96   text-xl text-gray-500 sm:text-center">Idéal pour jeux et calculs sur un cœur. Efficace, fiable, économique ⚙️</p>
							</div>
						</div>
					</div>
					<div class="row">
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<table class="table vps-hosting-pricing-table">
								...
								<tbody>
									<?php
										$json = file_get_contents("json/vps/intel.json");
		...
		<div class="container flex flex-col md:flex-row items-center p-6  shadow-md rounded-lg">
			<div class="md:w-1/2 p-4">
				<h1 class="text-2xl font-bold mb-4">Intel i9 9900KF / Intel i9-14900KS</h1>
				<p class="text-gray-700 mb-2">
					Découvrez la puissance exceptionnelle des processeurs Intel, conçus pour offrir des performances optimales dans toutes vos tâches, que ce soit pour les jeux, la création de contenu ou le travail intensif. Grâce à une architecture avancée et une efficacité énergétique remarquable, ces processeurs garantissent des vitesses de traitement ultra-rapides et une multitâche fluide.
				</p>
			</div>
			<div class="md:w-1/2 p-4">
				<img src="https://imgs.search.brave.com/l019EFCEwUAeQ3dZ0JKzYD7zklIukOrRQ-nFVmE-Jcc/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly9pbWcu/cGhvbmFuZHJvaWQu/Y29tLzIwMjIvMDgv/SW50ZWwtQ29yZS5q/cGc" alt="Processeur Intel" class="rounded-xl w-[28rem] shadow-md">
			</div>
		</div>
		<?php include "wdm.php"; ?>
	</body>
